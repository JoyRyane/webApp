...
<body>
    <?php 
        include "technicalVisit_php_connect.php" ;
        include "top_bar.php";
    ?>
    <?php
    ...
    <div class="container">
        <aside>
            <div class="sidebar">
				<a href="technical_visit.php" class="side__link ">
					...
					<h3>Dashboard</h3> 
				</a><a href="technicalVisit.php" class="side__link active">
		...
		<div class="wrapper">
            <h2>Technical Visit Registration</h2>
            <div class="input-box">
                <span class="input_success">
                    <?php echo $success; ?>
                </span>
            </div>
            <form action="technicalVisit.php" method="post" autocomplete="off">
                    ...
                    <div class="form-control">
                        ...
                        <div class="input-box">
                            ...
                            <textarea rows="3" columns="100" name="Notice" class="detail"><?php echo isset($_POST['Notice']) ? htmlspecialchars($_POST['Notice']) : '' ?></textarea>
                            <!--<label>Details</label>-->
                        </div>
                    </div>
