<?php
                    ...
                    while($record=mysqli_fetch_assoc($result))
                    {
                        ...
                        echo '
                            <tr>
                                ...
                                <td>'.$carReg.'</td>
                                <td>
                                    <button class="btn-success"><a href="myGrayCard_Show.php?showid='.$id.'" class="text-light">Details</a></button>
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "SELECT * FROM ministryoftransport WHERE Dealer = '$name' AND carReg LIKE '%$search%' or Owner LIKE '%$search%'";
