...
<body>
    <?php include 'luggageInsuranceShow_php_connect.php'?>
    <div class="container">
        <aside>
            <div class="top">
                <div class="logo">
		...
		<div class="wrapper">
            ...
            <p class="detail">Nature:              <br> <p class="value"><?php echo $Nature; ?></p> </p>
            ...
            <p class="detail">Further Details:     <br> <p class="value"><?php echo $Detail; ?></p> </p>
        </div>
		<div class="right">
			<div class="top">
				<button id="menu-btn">
