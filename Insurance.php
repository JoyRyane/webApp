...
<body>
    ...
    <div class="container">
        <aside>
            <div class="sidebar">
				<a href="Insurance.php" class="side__link  active">
					<span class="material-symbols-sharp">grid_view</span>
					<h3>Dashboard</h3> 
				</a>
                <a href="luggageInsurance.php" class="side__link">
                    <span class="material-symbols-sharp">insights</span>
                    <h3>Luggage Insurance Registration</h3>
                </a>
                <a href="vehicleInsurance.php" class="side__link">
                ...
                <a href="myVehicleInsuranceDisplay.php" class="side__link">
                    <span class="material-symbols-sharp">report_gmailerrorred</span>
                    <h3>Your Registered Vehicle Insurance</h3>
                </a>
                <a href="luggageInsuranceDisplay.php" class="side__link">
                    <span class="material-symbols-sharp">settings</span>
                    <h3>All Registered luggage Insurance</h3>
                </a>
                <a href="myLuggageInsuranceDisplay.php" class="side__link">
