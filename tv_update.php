		...
		if(isset($_POST['register'])){
			...
			$errors = array();
					...
					if(count($errors)>0){
						...
						$sql="update technicalvisit set id=$id,Owner='$Owner',Dealer='$Dealer',Email='$Email',
						carReg='$carReg',Details='$Details',Issuedate='$Issuedate' ,Expirydate='$Expirydate' where id=$id ";
						$result=mysqli_query($conn,$sql);
						if($result){
        ...
        <div class="form-box register">
				...
				<form action="" method="post">
                    ...
                    <div class="input-box">
						...
						<textarea rows="3" columns="45" name="Details" class="detail"><?php echo $Details; ?></textarea>
                        <!--<label>Details</label>-->
					</div>
					<div class="input-box">
