...
<body>
    <?php include "luggage_php_connect.php" ?>
    <div class="container">
        <aside>
            <div class="top">
                <div class="logo">
            ...
            <div class="sidebar">
                ...
                <a href="luggageInsuranceDisplay.php" class="active">
        ...
        <div class="wrapper">
            <h2>All Registered Luggage Insurance</h2>
                <button class="btn">
                    <a href="luggageInsurance.php" >Add user</a>
                </button>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    while($row=mysqli_fetch_assoc($result)){
                       ...
                       /* $Dealer = $row['Dealer'];
                        ...
                        <tr>
							...
							<td>'.$carReg.'</td>
                            <td>
                                <button class="btn-success"><a href="luggageInsurance_show.php?showid='.$id.'" class="text-light">Show</a></button>
                            </td>
                        </tr>
                        ';
                    }
